...
func _process(_delta):
	...
	if treme_tela ==true:
		vibra_tela()
	if inicio==1:
		marca_nota("sol3",55,530)
		marca_nota("sol3_sus",100,430)
		marca_nota("la3",140,530)
		marca_nota("la3_sus",187,430)
		marca_nota("si3",230,530)
		marca_nota("do4",320,530)
		marca_nota("do4_sus",365,430)
		marca_nota("re4",407,530)
		marca_nota("re4_sus",455,430)
		marca_nota("mi4", 495,530)
		marca_nota("fa4", 586,530)
		marca_nota("fa4_sus",630,430)
		marca_nota("sol4",675,530)
		marca_nota("sol4_sus",720,430)
		marca_nota("la4",765,530)
		marca_nota("la4_sus",810,430)
		marca_nota("si4",850,530)
		marca_nota("do5",945,530)
		marca_nota("do5_sus",990,430)
		marca_nota("re5",1030,530)
		marca_nota("re5_sus",1080,430)
		marca_nota("mi5",1120,530)
		marca_nota("fa5",1210,530)
		marca_nota("fa5_sus",1255,430)
		marca_nota("sol5",1300,530)
...
func acertou(nota:String) -> void:
	if get_tree().get_nodes_in_group(str(self)+nota).size()>0:
		...
		if GlobalIniciante.curLevel ==10 :
			x = x+140
			posicao(x,y)
		elif GlobalIniciante.curLevel ==11:
			x = x+140
			posicao(x,y)
		elif GlobalIniciante.curLevel ==14:
			x = x+140
			posicao(x,y)
		elif GlobalIniciante.curLevel ==15:
			x = x+140
			posicao(x,y)
		else:
			x = x+150
...
func alterado():
	if GlobalIniciante.curLevel ==9:
		x=250
#
	elif GlobalIniciante.curLevel ==10 :
		x=300
		
	elif GlobalIniciante.curLevel ==11 :
		x=300
		
	elif GlobalIniciante.curLevel ==13:
		x=250
